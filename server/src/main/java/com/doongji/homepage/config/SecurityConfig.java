...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    public JwtProvider jwtAuthenticationProvider(Jwt jwt, AccountService accountService) {
        return new JwtProvider(jwt, accountService);
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers("/api/main-data").permitAll()
                .antMatchers("/api/user/join").permitAll()
                .antMatchers("/api/post/**").hasAnyRole(Role.USER.name(), Role.ADMIN.name())
